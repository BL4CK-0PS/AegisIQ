...
| Asset Type | Location in App | Format |
|---|---|---|
| Logo | Navbar, landing page | SVG preferred, PNG fallback |
| Favicon | Browser tab | `.ico`, 32×32 |
| App Icon | PWA, mobile | SVG, 192×192, 512×512 |
| Illustrations | Empty states, onboarding | SVG |
| Brand PDF | Download | PDF |
