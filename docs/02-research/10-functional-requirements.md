...
This document defines every stakeholder who interacts with AegisIQ. Understanding users allows the platform to be designed around real operational needs rather than assumptions. The personas described here guide product design, UX, AI design, assessment design, feature prioritization, and the future roadmap.

Every feature in AegisIQ should trace back to at least one persona. If a feature serves none of them, it should be questioned before being built.
...
```
         ...
         ┌───────────────┼───────────────┐
         ▼               ▼               ▼
   Candidates        Recruiters     Organizations
         │               │               │
         ▼               ▼               ▼
     Trainers       Hiring        Universities
                    Managers
```

AegisIQ supports multiple user groups with distinct needs. Candidates complete assessments to validate and improve their skills. Recruiters and hiring managers use assessment outputs to inform their hiring decisions. Organizations (trainers, universities) use platform data to measure and improve workforce readiness.
...
|---|---|---|---|
| Candidate | Primary | P0 | Completes assessments, views reports |
| Recruiter | Primary | P0 | Creates assessments, reviews candidate reports |
| Hiring Manager | Primary | P0 | Evaluates candidate competency, makes hiring decisions |
...
| Build confidence for technical interviews | Self-rated confidence improves 2+ points (1-5 scale) |
...
| Pain Point | Impact |
|---|---|
| Does not know what to expect in technical interviews | Anxious and underprepared; cannot target study effectively |
...
| Learning roadmap | Clear path from current skill level to interview-ready |
...
| Objective | Success Signal |
|---|---|
| Validate technical skills to employers | Assessment report demonstrates competency to recruiters |
...
| Stand out from other entry-level candidates | Competency profile differentiates from certification-only applicants |

#### Pain Points

| Pain Point | Impact |
|---|---|
| Weak interview confidence | Good technical skills not reflected in interview performance |
| Difficulty explaining decisions clearly | Interviewers cannot assess depth of understanding |
| Limited industry exposure | No frame of reference for how real SOC teams operate |
| No feedback loop between interview attempts | Same mistakes repeated across multiple interviews |
...
| Recruiter-ready report | Share competency profile with potential employers |
...
| Attribute | Detail |
|---|---|
| **Title** | Technical Recruiter / HR Business Partner |
| **Technical Knowledge** | Low to Medium |
| **Hiring Volume** | High (10-50+ candidates per role) |
| **Stakeholders** | Hiring manager, HR team |
| **Primary Goal** | Screen technical candidates efficiently and consistently |

#### Objectives

| Objective | Success Signal |
|---|---|
| Screen candidates without deep cybersecurity knowledge | Report clearly indicates readiness without technical interpretation |
| Reduce time-to-interview for qualified candidates | Fewer hours spent on initial technical screening |
| Standardize evaluation across all candidates | Same rubric applied to every applicant |
...
| Pain Point | Impact |
|---|---|
| Cannot personally judge technical cybersecurity ability | Must forward all candidates to busy hiring manager |
| Resumes and certifications are unreliable signals | Certified candidates fail interview; non-certified candidates excel |
| Subjective evaluations lead to inconsistent hiring | Same candidate rated differently by different screeners |
...
| Feature | How It Serves This Persona |
|---|---|
| Recruiter-ready report | Clear readiness level and competency profile without cyber expertise needed |
| Competency dashboard | At-a-glance candidate comparison |
| Interview focus recommendations | Guides follow-up human interview on specific areas |
| Evidence-based scoring | Defensible rationale for every candidate decision |
...
| Objective | Success Signal |
|---|---|
| Evaluate operational readiness, not theoretical knowledge | Assessment measures how candidates respond to live incidents |
| Reduce bad hires that waste team training time | New hires contribute faster with less remediation |
| Standardize interview process across the team | Same evaluation criteria for every candidate |
| Get visibility into candidate reasoning process | Understand how candidates think, not just what they know |

#### Pain Points

| Pain Point | Impact |
|---|---|
| Inconsistent interviews across different team members | No standard for comparison across candidates |
| Candidates who interview well but struggle on the job | Interview signal does not predict job performance |
...
| Feature | How It Serves This Persona |
|---|---|
| Cyber reasoning evaluation | See how the candidate thinks through incidents |
| Explainable evidence | Every score backed by specific candidate statements |
| Decision quality analysis | Assess justification strength and risk awareness |
| Standardized rubric | Same criteria for every candidate, every time |
...
| Demonstrate program outcomes to employer partners | Share aggregate competency data with recruiting partners |
...
| Need | Feature |
|---|---|
| Program-level analytics | Cohort-wide competency distribution |
| Outcome reporting | Placement rate correlation with assessment scores |
| Skill trend analysis | Competency changes across semesters |
| Employer-ready reports | Shareable student competency profiles |
...
|---|---|---|
| Student | Become job-ready | Build confidence for interviews |
| Graduate | Secure first cybersecurity role | Differentiate from other candidates |
| SOC Analyst | Advance career | Benchmark against industry standards |
| Recruiter | Standardize candidate screening | Reduce time-to-interview |
...
| Pain Point | Student | Graduate | Analyst | Recruiter | Manager |
|---|---|---|---|---|---|
...
Review Learning Roadmap → Practice → Reassessment
```
...
Invite Candidate → Candidate Completes → Review Report →
...
| Decision / Action | Student | Graduate | Analyst | Recruiter | Manager | Trainer | University |
|---|---|---|---|---|---|---|---|
| Selects role or uploads JD | ✓ | ✓ | ✓ | ✓ | | | |
| Completes assessment | ✓ | ✓ | ✓ | | | | |
| Views own report | ✓ | ✓ | ✓ | | | | |
| Views candidate report | | | | ✓ | ✓ | ✓ | ✓ |
| Creates assessment | | | | ✓ | | ✓ | ✓ |
| Invites candidates | | | | ✓ | | | |
...
| Module | Student | Graduate | Analyst | Recruiter | Manager | Trainer | University |
|---|---|---|---|---|---|---|---|
| JD Intelligence | ✓ | ✓ | ✓ | ✓ | | | |
| Role Blueprint | ✓ | ✓ | ✓ | ✓ | | ✓ | ✓ |
...
### Candidates (Student, Graduate, Analyst)
...
| Criterion | Target |
|---|---|
| Screening time per candidate | < 30 minutes |
| Confidence in report accuracy | > 4.0 / 5.0 |
| Evaluation consistency across candidates | Same rubric, same standards |
...
```
Candidate (Student / Graduate / Analyst)
        │
        ▼
  Assessment — Complete adaptive cyber missions
        │
        ▼
  Report — Receive explainable competency profile
        │
        ▼
  Learning Roadmap — Actionable improvement path
...
Recruiter
  ...
  Create Assessment — Configure from JD or template
        │
        ▼
  Review Reports — Evaluate candidates with evidence
        │
        ▼
...
Every feature in AegisIQ should trace back to at least one of these personas. If a feature serves no persona, it does not belong in the MVP.
